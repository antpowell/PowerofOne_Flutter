          ...
          case '1PT':
            {
              if (value >= 70){
                ...
                _feedback[key] = 'Improvement Needed;Focus on shooting more free throws in practice';
              }
            }
            break;
      };
...
Map<String,String> hustlepointsfeedback(Map<String, Play> totalhustlepoints){
        ...
        case 'TO':
          {
            if (value.pos == 0){
              ...
              _hustlepointsfeedback[key] = "Improvement Needed; Work on Ball Handling";
            }
            break;
          }
        case 'ASST':
          {
            if (value.pos >= 4){
              ...
              _hustlepointsfeedback[key]="Improvement Needed; Focus on Passing";
            }
            break;
          }
      }
