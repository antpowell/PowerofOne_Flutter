  ...
  List<PageViewModel>getPages(){
    return[
      ...
      PageViewModel(
        ...
        title:"Hustle Points",
        body:"Tap these buttons on the score card screen to track your steals, rebounds,assist, and blocks",
        decoration: const PageDecoration(
          titleTextStyle: TextStyle(color:Colors.white),
          bodyTextStyle: TextStyle(color:Colors.white),
        ),
      ...
      PageViewModel(
       image: Image.asset("assets/images/shooting_points.png"),
        ...
        body:"Tap these buttons on the right side of the score card screen to track how many points you score in a games",
        decoration: const PageDecoration(
          titleTextStyle: TextStyle(color:Colors.white),
          bodyTextStyle: TextStyle(color:Colors.white),
        ),
      ...
      PageViewModel(
       // image: Image.asset("assets/images/POWER_OF_1_SPORT_LO-FF.png"),
        title:"Report Card",
        body:"A final review of total points scored and you will receive your Power of 1 Grade",
        decoration: const PageDecoration(
          titleTextStyle: TextStyle(color:Colors.white),
          bodyTextStyle: TextStyle(color:Colors.white),
        ),
