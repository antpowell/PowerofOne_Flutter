...
import 'package:power_of_one_basketball/Views/ScoreCard/ScoreBoardPointsDisplay.dart';
...
class ScoreBoard extends StatelessWidget {
  ...
  List<Widget> _createDualScoreSectionLists(PO1Score a) {
    a.pointsMap.keys.forEach(
      (element) => _dualScoreSection.add(
        ScoreBoardPointsDisplay(element.translatedName),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          child: Column(children: _createDualScoreSectionLists(activities)),
        ),
        Container(
          child: Row(
